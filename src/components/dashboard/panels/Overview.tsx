    ...
    <div className="p-6 lg:p-8 min-h-screen">
      ...
      >
        ...
        <motion.p 
          ...
          variants={itemVariants}
        >
          HivemindOS is operating at optimal parameters
        </motion.p>
      </motion.div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mb-2">
                    Agent Cortexa is using more memory than expected. Consider optimizing or reallocating resources.
                  </p>
                  <div className="flex items-center">
            ...
            <div className="p-4 rounded-lg bg-dark-300/50 border border-dark-100/30">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mb-2">
                    Agent Bart has completed model training with improved accuracy of +2.7%.
                  </p>
                  <div className="flex items-center">
